...
variants_text = {
    'Вариант 7': 'Вариант 7: \"Найти средний возраст пассажиров по каждому классу обслуживания (поле Pclass, указав количество братьев, сестер... (столбец SibSp): [0, …, 8].\"',
    'Вариант 11': 'Вариант 11: \"Вычислить долю погибших и спасенных пассажиров, указав возрастную категорию из списка - \"молодой\" (до 30 лет), \"среднего возраста\" (от 30 до 60) и \"старый\" (более 60 лет)\"',
    'Вариант 12': 'Вариант 12: \"Подсчитать количество и процент пропусков в данных для указанного столбца (из списка)\"',
    'Вариант 14': 'Вариант 14: \"Посчитать число родственников отдельно для выживших и погибших пассажиров указанного пола\"',
    'Вариант 17': 'Вариант 17: \"Вычислить среднюю, минимальную или максимальную (выбрать из списка) стоимость билета у пассажиров по каждому пункту посадки\"'
}
